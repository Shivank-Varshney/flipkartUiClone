      ...
      <div className="container-fluid information">
        ...
        <div className="row">
          <div className="col">
            ...
            <p className="info">
              ...
              Flipkart order, Plus members earns 4 supercoins &amp; non-plus
              members earn 2 supercoins. Free delivery, early access during
              sales and shopping festivals, exchange offers and priority
              customer service are the top benefits to a Flipkart Plus member.
              In short, earn more when you shop more!
            </p>
            <p className="info">
        ...
        <div className="row">
          <div className="col">
            ...
            <p className="info">
              ...
              and software glitches, and replacements -{" "}
        ...
        <div className="row">
          <div className="col">
            ...
            <p className="info">
              ...
              what laptop to get? Our <b>Back To College Store</b> segregates
              laptops purpose wise (gaming, browsing and research, project work,
        ...
        <div className="row">
          <div className="col">
            <h2>Lifestyle</h2>
            <p className="info">
              Flipkart, <b>'India ka Fashion Capital'</b>, is your one-stop
              fashion destination for anything and everything you need to look
              good. Our exhaustive range of Western and Indian wear, summer and
              winter clothing, formal and casual footwear, bridal and artificial
        ...
        <div className="row">
          <div className="col">
            ...
            <p className="info">
              ...
              second thought. Huggies, Pampers, MamyPoko, and Johnson &amp;
              Johnson: we host only the most-trusted names in the business for
              your baby.
            </p>
          </div>
        </div>
        ...
        <div className="row">
          <div className="col">
            ...
            <p className="info">
              ...
              grooming to cleaning agents, we are happy to present everything
              you need to run a house. Now buy Grocery products for as low as 1
              Rupee only - our <b>1 Rupee Store</b> presents new products every
              day for a nominal price of 1 Rupee only. Terms and conditions
              apply.
            </p>
          </div>
        </div>
